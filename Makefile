...
DISTDIR = /home/kali/progs/ProgC/3course/maintask/Approx/graph_qt5/.tmp/basic_graph1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1
...
moc_window.cpp: window.h \
		moc_predefs.h \
		/usr/lib/qt5/bin/moc
	/usr/lib/qt5/bin/moc $(DEFINES) --include /home/kali/progs/ProgC/3course/maintask/Approx/graph_qt5/moc_predefs.h -I/usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++ -I/home/kali/progs/ProgC/3course/maintask/Approx/graph_qt5 -I/usr/include/x86_64-linux-gnu/qt5 -I/usr/include/x86_64-linux-gnu/qt5/QtWidgets -I/usr/include/x86_64-linux-gnu/qt5/QtGui -I/usr/include/x86_64-linux-gnu/qt5/QtCore -I/usr/include/c++/15 -I/usr/include/x86_64-linux-gnu/c++/15 -I/usr/include/c++/15/backward -I/usr/lib/gcc/x86_64-linux-gnu/15/include -I/usr/local/include -I/usr/include/x86_64-linux-gnu -I/usr/include window.h -o moc_window.cpp
...
mainzip:
	zip $(MAINZIPNAME).zip basic_graph.pro window.h main.cpp \
		window.cpp Makefile

zip:
	zip $(ZIPNAME).zip basic_graph.pro window.h main.cpp \
		window.cpp Makefile
